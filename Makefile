...
install:
	for i in handle_http_basic.lua rgb.lua melody.lua nettime.lua clock.lua modes.lua twokeys.lua cfgedit.lua compile.lua wifiautoconnect.lua mqtt.lua autostart.lua; do \
